...
def map_create(noms_fichiers_mdl:list[str], nom_fichier:str):
...
def map_modif(nom_fichier:str):
    ...
    dessinateur = Dessinateur(frame_principale, selector, image_base=fichier_origine.image, modifs=fichier_origine.get_raw())
...
class Dessinateur:
    def __init__(self, frame: tk.Frame, selector:Selecteur | None = None, *, image_base: Image_PIL.Image = IMAGE_VIDE, modifs: list[tuple[bytes, str, int, int]] | None = None, rely:float = 0, relx:float = 0.25, cursor:str = "none") -> None:
